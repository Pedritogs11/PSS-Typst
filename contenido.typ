...
#pagebreak()
= Anexo II Procedimiento de medición de corrientes y tensiiones en cuaros eléctricos de corriente continua en altura <anexoIImal>


#pagebreak()

#let start = <anexoIImal>
#let end =  heading.where(level: 1).after(start, inclusive: false);
*ÍNDICE ANEXO IImal*
...
Inmediatamente después de finalizar el trabajo, el responsable de trabajo cumplimentará el parte de trabajo y albarán de material, indicando el trabajo realizado y las incidencias ocurridas. 
Al final de la jornada, el parte de trabajo y albarán de material serán entregados a la empresa.
...
= Anexo III Medición y limpieza del inversor <anexoIII>
...
Establecer procedimientos de trabajo para verificar que la medición del display del inversor coincide con la medición realizada en corriente continua y alterna, realización de la limpieza del inversor.
...
El trabajador en fecha planificada se desplazará a la empresa con los medios y materiales necesarios y deberá contactar en la empresa con el representante antes de efectuar cualquier operación.
...
= Anexo IV Procedimiento de reparación de averías <anexoIV>
...
=== Representane de la empresa contratista
...
=== Anomalía en las averías de módulo o el cableado de corriente continua en cubierta
...
=== Anomalías en una instalación fotovoltaica
...
=== Registro del trabajo realizado en el parte del trabajo
