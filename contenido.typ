...
#table(
  columns: (auto, auto),
  table.header([Riesgo], [Medidas de protección colectiva]),
  table.cell(rowspan: 5, [Caída de personas al mismo nivel]), [Medidas de orden y limpieza en el puesto de trabajo:],
  [Orden y limpieza:
  ...
  table.cell(rowspan: 6, [Caída de personas a distinto nivel]), [Colocación de barandillas:],
  ...
  table.cell(rowspan: 2, [Proyecciones de partículas, golpes, cortes y atrapamientos por herramientas]), [Resguardos de máquinas],
  ...
  table.cell(rowspan: 8, [Contactos eléctricos]),[Conexión a tierra de cuadros y equipos de suministro de energía eléctrica:],
  ...
  table.cell(rowspan: 2, [Atropellos, choques y vuelcos con maquinaria pesada]), [Señalización y balizamiento de la obra:],
  ...
  table.cell(rowspan: 2,[Derrumbe o sepultamiento:]), [Entibación y perfilado de taludes, fosos y zanjas:],
  ...
  table.cell(rowspan: 4, [Incendios y explosiones]), [Protección y control del fuego:],
